...
<script type="text/javascript">
    Joomla.submitbutton = function (task) {
        if (task === 'parent.cancel' || document.formvalidator.isValid(document.id('adminForm'))) {
    ...
    <div class="row-fluid">
        <div class="span12 form-horizontal">
            ...
            <div class="tab-content">
                <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::sprintf('COM_COMPANIES_TAB_CHILDREN_GENERAL')); ?>
                <div class="row-fluid">
                    <div class="span6">
