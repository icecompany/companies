...
let Company = {
    ...
    load: function () {
        let id = document.querySelector("#jform_hidden_client_id").value;
        let value = document.querySelector("#jform_hidden_client_title").value;
        if (id !== '' && value !== '') {
...
window.onload = function () {
    UI.Fields.par.elem = jQuery("#jform_clientID");
    UI.Fields.par.chzn = document.querySelector("#jform_clientID_chzn");
    UI.Fields.par.inp = document.querySelector("#jform_clientID_chzn .chzn-drop .chzn-search input");
    UI.Fields.unlock(UI.Fields.par);
    Company.load();
...
Joomla.submitbutton = function (task) {
    ...
    if (task === 'cooperation.cancel' || valid) {
