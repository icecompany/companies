...
(
    ...
    constraint `s7vi9_mkv_companies_parents_pk`
        primary key (id),
    constraint `s7vi9_mkv_companies_s7vi9_mkv_companies_id_id_fk`
        foreign key (companyID) references `s7vi9_mkv_companies` (id)
            on update cascade on delete cascade,
    constraint `s7vi9_mkv_parents_s7vi9_mkv_companies_id_id_fk`
        foreign key (parentID) references `s7vi9_mkv_companies` (id)
            on update cascade on delete cascade
) character set utf8
